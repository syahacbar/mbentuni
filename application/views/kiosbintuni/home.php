										...
										<div class="menu_body">
										   <div class="list">
											  ...
											  <?php foreach ($get_all_kategori->result_array() as $a) { ?>
					                             <li><a href="#"><?php echo $a['kategori_nama'];?></a></li>
											  <?php } ?>
					                         </ul>
									  </div>	
									</div>								
  ...
  <div class="main">
      ...
      <div class="content">
    	<div class="content_top">
          ...
          <?php foreach ($get_all_produk1->result_array() as $a) { ?>
          ...
          <?php } ?>	
			...
			<div class="section group">
          <?php foreach ($get_all_produk2->result_array() as $a) { ?>
				<div class="grid_1_of_2 images_1_of_2">
					 <a href="<?php echo base_url().'menu/detail_menu/'.$a['menu_id'];?>"><img src="<?php echo base_url('assets/gambar').'/'.$a['menu_gambar'];?>" alt="" /></a>
					 <h2><a href="<?php echo base_url().'menu/detail_menu/'.$a['menu_id'];?>"><?php echo $a['menu_nama'];?></a></h2>
					<div class="price-details">
          ...
          <?php } ?>	
			...
			<div class="section group">
          <?php foreach ($get_all_produk3->result_array() as $a) { ?>
				<div class="grid_1_of_2 images_1_of_2">
					 <a href="<?php echo base_url().'menu/detail_menu/'.$a['menu_id'];?>"><img src="<?php echo base_url('assets/gambar').'/'.$a['menu_gambar'];?>" alt="" /></a>
					 <h2><a href="<?php echo base_url().'menu/detail_menu/'.$a['menu_id'];?>"><?php echo $a['menu_nama'];?></a></h2>
					<div class="price-details">
