...
class M_order extends CI_Model{
	...
	function order_produk($no_invoice,$total){
		...
		$inv_plg_nama=$this->session->userdata('plg_nama');
		$this->db->query("INSERT INTO tbl_invoice (inv_no,inv_plg_id,inv_plg_nama,inv_status,inv_total) VALUES ('$no_invoice','$inv_plg_id','$inv_plg_nama','Menunggu Konfirmasi','$total')");
