...
class M_pelanggan extends CI_Model{
	...
	function cek_pelanggan($plg_nama){
		$hsl=$this->db->query("select * from tbl_pelanggan where plg_nama='$plg_nama'");
		return $hsl;
	}
	...
	function simpan_customer($nama){
		$hsl=$this->db->query("INSERT INTO tbl_pelanggan(plg_nama) VALUES ('$nama')");
		return $hsl;
	}
